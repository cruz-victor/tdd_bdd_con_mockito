...
public class NumerosRomanosTest {
    ...
    @Test
    public void verficarVeintenaNumerosRomanso(){
    ...
    @Test
    public void verificarDecenasRomanos(){
        List<Integer> numerosNaturales=Arrays.asList(20,30,40,50,60,70,80,90, 87, 59);
        ...
        assertEquals(romanos.get(0),"XX");
        assertEquals(romanos.get(1),"XXX");
        assertEquals(romanos.get(2),"XL");
        assertEquals(romanos.get(3),"L");
        assertEquals(romanos.get(4),"LX");
        assertEquals(romanos.get(5),"LXX");
        assertEquals(romanos.get(6),"LXXX");
        assertEquals(romanos.get(7),"XC");
        assertEquals(romanos.get(8),"LXXXVII");
